/**
 * Brand icons that lucide-react doesn't ship. Lucide dropped brand/logo
 * marks (Github, LinkedIn included) from its icon set, so these are the
 * only icons in the platform that aren't Lucide imports. Kept in shared/
 * rather than duplicated per-consumer — Header and Footer both use
 * `GithubIcon`; `LinkedinIcon` is Footer's alone so far.
 */
